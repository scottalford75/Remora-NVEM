/********************************************************************
* Description:  remora-nv.c
*               This file, 'remora-nv.c', is a HAL component that
*               provides an ethernet connection to a external Novusun controller
*			    running Remora PRU firmware.
*  				
*
* Author: Scott Alford
...
*
* Copyright (c) 202All rights reserved.
*
* Last change:
********************************************************************/
